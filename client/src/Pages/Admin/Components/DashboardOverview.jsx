  ...
  return (
    <div className="w-full">
      ...
      <div className="bg-white p-5 rounded-md shadow-sm mb-8">
        <h3 className="text-xl poppins mb-4">Quick Actions</h3>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-white p-5 rounded-md shadow-sm">
          <h3 className="text-xl poppins mb-4">Recent Users</h3>
        ...
        {/* Recent Products */}
        <div className="bg-white p-5 rounded-md shadow-sm">
          <h3 className="text-xl poppins mb-4">Recent Products</h3>
          <div className="overflow-hidden">
            <table className="min-w-full">
              <thead>
                <tr className="bg-gray-100">
