    ...
    <div className='w-full flex pt-40 justify-center items-center'>
      <div className='w-[90vw] bg-white grid grid-cols-12 rounded-md shadow-md'>
        <div className="rounded-md col-span-2 p-5 flex flex-col light-green-bg min-h-[calc(100vh-200px)]">
          <h2 className="moret text-xl mb-6 text-center">Admin Panel</h2>
          ...
          <div className="w-full">
            ...
            >
              ...
              <span className="poppins text-base">Overview</span>
            </div>
            ...
            <div 
              ...
              onClick={() => handleButtonClick('users', 'User Management')}
            >
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" />
              </svg>
              <span className="poppins text-base">Users</span>
            </div>
            ...
            <div 
              ...
              onClick={() => handleButtonClick('products', 'Product Management')}
            >
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z" />
              </svg>
              <span className="poppins text-base">Products</span>
            </div>
            ...
            <div 
              ...
              onClick={() => handleButtonClick('categories', 'Category Management')}
            >
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z" />
              </svg>
              <span className="poppins text-base">Categories</span>
            </div>
            ...
            <div 
              ...
              onClick={() => handleButtonClick('farmers', 'Farmer Management')}
            >
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
              </svg>
              <span className="poppins text-base">Farmers</span>
            </div>
            ...
            <div 
              ...
              onClick={() => handleButtonClick('orders', 'Order Management')}
            >
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" />
              </svg>
              <span className="poppins text-base">Orders</span>
            </div>
          </div>
