    ...
    <div className='w-full flex items-center justify-center'>
        <div className='w-[80vw]  grid grid-cols-12 rounded-xl h-[90vh] mt-10'>
            ...
            <div className="col-span-6 pl-10 flex flex-col h-full form-side-containers justify-center rounded-tr-xl rounded-br-xl">
                    <h1 className='poppins text-3xl font-medium'>Krijoni llogarine tuaj</h1>
                    <input className='w-[80%] rounded-md form-inputs px-3 py-3 mt-5' placeholder='Emri ...' type="text" />
                    <input className='w-[80%] rounded-md form-inputs px-3 py-3 mt-5' placeholder='Mbiemri...' type="text" />
                    <input className='w-[80%] rounded-md form-inputs px-3 py-3 mt-5' placeholder='Email...' type="text" />
                    ...
                    <button className='poppins text-base font-normal w-fit mt-3 px-6 py-2 light-green-bg'>dergo</button>
            </div>
        </div>
    </div>
  )
